      ...
      <div class="service-text">
        ...
        <?php if( get_theme_mod('ecommerce_watch_store_button_text','Read More') != ''){ ?>
          <div class="more-btn mt-4 mb-4">
            <a href="<?php the_permalink(); ?>"><?php echo esc_html(get_theme_mod('ecommerce_watch_store_button_text',__('Read More','ecommerce-watch-store')));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('ecommerce_watch_store_button_text',__('Read More','ecommerce-watch-store')));?></span></a>
          </div>
        <?php } ?>
      </div>
  </div>
