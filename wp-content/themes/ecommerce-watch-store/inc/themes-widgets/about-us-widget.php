...
class Ecommerce_Watch_Store_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Ecommerce_Watch_Store_About_Widget',
			__('VW About us', 'ecommerce-watch-store'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'ecommerce-watch-store' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','ecommerce-watch-store'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','ecommerce-watch-store'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','ecommerce-watch-store'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','ecommerce-watch-store'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','ecommerce-watch-store'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','ecommerce-watch-store'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function ecommerce_watch_store_about_custom_load_widget() {
	register_widget( 'Ecommerce_Watch_Store_About_Widget' );
}
add_action( 'widgets_init', 'ecommerce_watch_store_about_custom_load_widget' );