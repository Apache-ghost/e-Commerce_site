...
if ( ! class_exists( 'Ecommerce_Watch_Store_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Ecommerce_Watch_Store_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Ecommerce_Watch_Store_WPTT_WebFont_Loader( $url );
